...
- (CGRect)menuFrame {
    CGFloat menuX = [UIScreen mainScreen].bounds.size.width - 60;
    CGFloat menuY = -60;
...

{
    ...
    CGFloat location = [UIScreen mainScreen].bounds.size.width+6;
    CGContextMoveToPoint(context,
                         location -  10 - 10, 110-50);//设置起点
    
    CGContextAddLineToPoint(context,
                            location - 2*10 - 10 ,  100-50);
    
    CGContextAddLineToPoint(context,
                            location - 10 * 3 - 10, 110-50);
